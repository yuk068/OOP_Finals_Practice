...
import yukwork.datastructure.nongenerics.mylist.mydeque.MyDeque;
...
import yukwork.datastructure.nongenerics.mylist.mypriorityqueue.MyPriorityQueue;
import yukwork.datastructure.nongenerics.mylist.myqueue.MyQueue;
import yukwork.datastructure.nongenerics.mylist.mystack.MyStack;
...
public class TestList {
    ...
    private static String priorityQueueToString(MyPriorityQueue pq) {
        StringBuilder sb = new StringBuilder("[");
        MyIterator iterator = pq.iterator();
    ...
    private static String dequeToString(MyDeque deque) {
        StringBuilder sb = new StringBuilder("[");
        MyIterator iterator = deque.iterator();
        while (iterator.hasNext()) {
            sb.append(iterator.next());
            if (iterator.hasNext()) {
                sb.append(", ");
    ...
    public static void testList(MyList list) {
        ...
        List<Object> arrayList = list.toList();
